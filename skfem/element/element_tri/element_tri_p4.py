...
class ElementTriP4(ElementH1):
    ...
    def lbasis(self, X, i):
        ...
        if i == 0:  # (0., 0.)
            phi = 1/6*(1-x-y)*(4*(1-x-y)-1)*(4*(1-x-y)-2)*(4*(1-x-y)-3)
            dphi = np.array([
                (128*x**3)/3 + 128*x**2*y - 80*x**2 + 128*x*y**2 - 160*x*y + (140*x)/3 + (128*y**3)/3 - 80*y**2 + (140*y)/3 - 25/3,
                (128*x**3)/3 + 128*x**2*y - 80*x**2 + 128*x*y**2 - 160*x*y + (140*x)/3 + (128*y**3)/3 - 80*y**2 + (140*y)/3 - 25/3
            ])
        elif i == 1:  # (1., 0.)
            ...
            phi = 8/3*x*(1-x-y)*(4*(1-x-y)-1)*(4*(1-x-y)-2)
            dphi = np.array([
            ...
            dphi = np.array([
                256*x**3 + 384*x**2*y - 384*x**2 + 128*x*y**2 - 288*x*y + 152*x - 16*y**2 + 28*y - 12,
                4*x*(4*x - 1)*(8*x + 8*y - 7)   
            ])
        elif i == 5:  # 0->1: (3/4,0)
            ...
            phi = 8/3*y*(1-x-y)*(4*(1-x-y)-1)*(4*(1-x-y)-2)
            dphi = np.array([
            ...
            dphi = np.array([
                4*y*(4*y - 1)*(8*x + 8*y - 7),
                128*x**2*y - 16*x**2 + 384*x*y**2 - 288*x*y + 28*x + 256*y**3 - 384*y**2 + 152*y - 12   
            ])
        elif i == 11:  # 0->2: (0,3/4)  
