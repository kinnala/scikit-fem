        ...
        return {
            2: (np.array([[0.5854101966249685,
                          ...
                          [0.1381966011250105,
                           ...
                           0.5854101966249685,
                           0.1381966011250105]]),
                np.array([0.2500000000000000,
                          0.2500000000000000,
                          0.2500000000000000,
                          0.2500000000000000]) / 6.),
            3: (np.array([[0.2500000000000000,
                           0.5000000000000000,
                           0.1666666666666667,
                           0.1666666666666667,
                           0.1666666666666667],
                          ...
                          [0.2500000000000000,
                           ...
                           0.5000000000000000,
                           0.1666666666666667]]),
                np.array([-0.8000000000000000,
                          0.4500000000000000,
                          0.4500000000000000,
                          0.4500000000000000,
                          0.4500000000000000]) / 6.),
            4: (np.array([[0.2500000000000000,
                           0.7857142857142857,
                           0.0714285714285714,
                           0.0714285714285714,
                           0.0714285714285714,
...
def get_quadrature_tri(norder: int) -> Tuple[np.ndarray,
                                             np.ndarray]:
    ...
    try:
        return {
            2: (np.array([[1.666666666666666666666e-01,
                           6.666666666666666666666e-01,
                           1.666666666666666666666e-01],
                          [1.666666666666666666666e-01,
                           1.666666666666666666666e-01,
                           6.666666666666666666666e-01]]),
                np.array([1.666666666666666666666e-01,
                          1.666666666666666666666e-01,
                          1.666666666666666666666e-01])),
            3: (np.array([[0.333333333333333,
                           0.2,
                           0.6,
                           0.2],
                          [0.333333333333333,
            ...
            4: (np.array([[0.445948490915965,
                          ...
                          [0.10810301816807,
                           ...
                           0.445948490915965,
                           0.0915762135097699]]),
                np.array([0.111690794839006,
                          0.054975871827661,
                          0.111690794839006,
                          0.054975871827661,
                          0.111690794839006,
                          0.054975871827661])),
            5: (np.array([[0.333333333333333,
                           0.470142064105115,
                           0.101286507323457,
                           0.05971587178977,
                           0.797426985353087,
...
def get_quadrature_line(norder: int) -> Tuple[np.ndarray, np.ndarray]:
    ...
    if norder <= 1:
        norder = 2
    X, W = np.polynomial.legendre.leggauss(int(np.ceil((norder + 1.) / 2.)))
    return np.array([.5 * X + .5]), W / 2.
