...
class TestEx04(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(np.max(ex04.x), 0.0294118495011)
...
class TestEx07(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(np.max(ex07.x), 0.077891428529719878)
...
class TestEx21(unittest.TestCase):
    def runTest(self):
        ...
        K = ex.K
        L = ex.L[0]
        self.assertAlmostEqual(y.T @ K @ y, 253739.1255284172)
        self.assertAlmostEqual(L, 253739.12552853522)
