...
from cudaskfem.assembly.dofs import Dofs
from cudaskfem.element import (DiscreteField, Element, ElementComposite,
                           ElementVector)
from cudaskfem.mapping import Mapping
from cudaskfem.mesh import Mesh
from cudaskfem.quadrature import get_quadrature
from cudaskfem.refdom import Refdom
...
class AbstractBasis:
    ...
    def _projection(self, interp, dtype=None):
        ...
        from cudaskfem.helpers import inner
