...
class Mesh:
    ...
    @property
    def dofs(self):
        from cudaskfem.assembly import Dofs
    ...
    def _mapping(self):
        from cudaskfem.mapping import MappingAffine, MappingIsoparametric
    ...
    def save(self,
        ...
        """
        from cudaskfem.io.meshio import to_file
        return to_file(self,
                       filename,
                       point_data,
                       cell_data,
    ...
    def load(cls,
        ...
        """
        from cudaskfem.io.meshio import from_file
