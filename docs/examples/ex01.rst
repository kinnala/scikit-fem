...
quadrature points. This is done by creating
...
:class:`~skfem.element.ElementTriP1` is derived from :class:`~skfem.element.Element` and it defines
the basis functions and local-to-global transformation rules.
...
All assembly operations are performed with the function :func:`~skfem.assembly.asm`,
...
We are left with solving the assembled linear system.  Due to the zero boundary
