...
quadrature points. This could be done as before but we demonstrate instead
...
As the Morley element is based on piecewise quadratic basis
functions, we cannot appreciate the discrete solution
unless we further refine the mesh for visualisation
purposes. The refine and interpolation is done using
:meth:`~skfem.assembly.InteriorBasis.refinterp` as follows:

.. literalinclude:: ../examples/ex02.py
    :lines: 60-64

.. figure:: ../examples/ex02_solution.png
